...
data_set = 'lm_180601_000'
data_set_flt_drk = 'lm_180531_00'
wd = 'WD1900+705'
master_path = '/Users/Ryan/research/data/WD1900+705/'
...
crop_parameter = 250
star_mag = 13.439
points = [(850,400),(550,550),(275,830)]
width = 100
...
#pro.nod_subtract(master_path,data_set,'sci_edge_cropped',start_frame,179,path_subtracted,progress_print=True)
#pro.nod_subtract(master_path,data_set,'sci_edge_cropped',178,end_frame,path_subtracted,progress_print=True)
#
