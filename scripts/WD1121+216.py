...
data_set = 'lm_180108_0'
data_set_flt_drk = 'lm_180105_00'
wd = 'WD1121+216'
master_path = '/Users/Ryan/research/data/WD1121+216/'
...
crop_parameter = 250
star_mag = 13.420
points = [(1000,300),(700,500),(350,700)]
width = 100
...
#pro.nod_subtract(master_path,data_set,'sci_edge_cropped',start_frame,9818,path_subtracted,progress_print=True)
#pro.nod_subtract(master_path,data_set,'sci_edge_cropped',9809,end_frame,path_subtracted,progress_print=True)
#
