...
master_path = '/Users/Ryan/research/data/WD0148+467_luci/'
...
#uti.nod_appender_A(master_path,data_set,'raw_data',start_frame,334,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',334,354,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',354,374,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',374,394,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',394,414,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',414,434,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',434,end_frame,progress_print=True)
#
#
##cropping
...
#pro.nod_subtract(master_path,data_set,'sci_edge_cropped',start_frame,423,path_subtracted,progress_print=True)
#pro.nod_subtract(master_path,data_set,'sci_edge_cropped',423,end_frame,path_subtracted,progress_print=True)
#
...
#
##Bad frame detection
#pro.frame_filter(master_path,data_set,'centered',start_frame,end_frame,path_filtered,progress_print=True,fwhm_tolerance=80,peak_tolerance=85)
#
...
pro.contrast_curve_test(master_path,data_set,'ultra_centered',start_frame,end_frame,path_median_psf,progress_print=True,frame_set='master_no_flt',luci=True)