...
data_set = 'lm_170208_00'
data_set_flt_drk = 'lm_170208_0'
wd = 'WD1134+300'
master_path = '/Users/Ryan/research/data/WD1134+300/2-8-17/'
...
start_frame = 44
start_frame_drk = 1493
start_frame_flt = 1483
...
crop_parameter = 250
star_mag = 13.105
points = [(1180,450),(930,630),(500,950)]
width = 100
...
##Nods incorrectly labeled as DRKs in header
#uti.nod_appender_A(master_path,data_set,'raw_data',start_frame,49,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',49,54,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',54,59,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',59,64,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',64,69,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',69,79,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',79,84,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',84,89,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',89,94,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',94,end_frame,progress_print=True)
#
##cropping
...
#pre.dewarper(master_path,data_set,'stripe_crcted',start_frame,end_frame,path_dewarped,crop_bottom=cb,crop_top=ct,crop_left=cl,crop_right=cr,date='2017A',side='dx',progress_print=True)
#
