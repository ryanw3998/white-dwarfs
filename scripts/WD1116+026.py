...
data_set = 'lm_190224_00'
data_set_flt_drk = 'lm_190224_00'
wd = 'WD1116+026'
master_path = '/Users/Ryan/research/data/WD1116+026/'
...
start_frame = 6462
start_frame_drk = 6548
start_frame_flt = 7135
...
crop_parameter = 250
star_mag = 14.730
points = [(1300,600),(780,780),(450,1100)]
width = 100
...
#uti.biassub(master_path,data_set,'raw_data_bias',start_frame_drk,end_frame_drk,path_raw_data,progress_print=True)
#uti.biassub(master_path,data_set,'raw_data_bias',start_frame_flt,end_frame_flt,path_raw_data,progress_print=True)
#
##cropping
