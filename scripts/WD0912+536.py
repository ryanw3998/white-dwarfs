...
data_set = 'lm_171223_00'
data_set_flt_drk = 'lm_171223_00'
wd = 'WD0912+536'
master_path = '/Users/Ryan/research/data/WD0912+536/'
...
#pre.dewarper(master_path,data_set,'stripe_crcted',start_frame,end_frame,path_dewarped,crop_bottom=cb,crop_top=ct,crop_left=cl,crop_right=cr,date='2017B',side='sx',progress_print=True)
#
