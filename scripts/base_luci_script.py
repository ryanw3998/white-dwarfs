...
data_set = 'luci2.********.*'
data_set_flt_drk = 'luci2.********.*'
master_path = '/Users/Ryan/research/data/WD********/'
...
uti.decompressor(master_path,data_set,'raw_data',start_num,end_frame_num,path_raw_data,progress_print=True,luci=True)

#Nod appending images
uti.nod_appender_A(master_path,data_set,'raw_data',***,***,progress_print=True)
uti.nod_appender_B(master_path,data_set,'raw_data',***,***,progress_print=True)
...
pre.dewarper(master_path,data_set,'stripe_crcted',start_frame,end_frame,path_dewarped,crop_bottom=cb,crop_top=ct,crop_left=cl,crop_right=cr,date='',side='',progress_print=True,luci=True)
...
pro.median_psf_subtraction(master_path,data_set,'ultra_centered',start_frame,end_frame,path_median_psf_subtraction,wd=wd,progress_print=True,frame_set='master',luci=True)

#Median combining PSF with and without rotation
pro.psf_stacker(master_path,data_set,'ultra_centered',start_frame,end_frame,path_median_psf,wd=wd,progress_print=True,frame_set='master',luci=True)

#Contrast curve for median psf subtraction method
pro.contrast_curve_vip(master_path,data_set,'ultra_centered',start_frame,end_frame,path_median_psf,wd=wd,star_mag=star_mag,progress_print=True,method='median_psf_subtraction',luci=True,tag='')

#Contrast curve for llsg psf subtraction method
pro.contrast_curve_vip(master_path,data_set,'ultra_centered',start_frame,end_frame,path_median_psf,wd=wd,star_mag=star_mag,progress_print=True,method='llsg_psf_subtraction',luci=True,tag='')
