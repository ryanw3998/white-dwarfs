...
pre.dewarper(master_path,data_set,'stripe_crcted',start_frame,end_frame,path_dewarped,crop_bottom=cb,crop_top=ct,crop_left=cl,crop_right=cr,date='',side='',progress_print=True)
...
pro.contrast_curve_vip(master_path,data_set,'ultra_centered',start_frame,end_frame,path_median_psf,wd=wd,star_mag=star_mag,progress_print=True,method='llsg_psf_subtraction',luci=False,tag='')
