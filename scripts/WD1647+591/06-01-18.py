...
wd = 'WD1647+591'
master_path = '/Users/Ryan/research/data/WD1647+591/6-1-18/'
...
crop_parameter = 250
star_mag = 13.211
points = [(850,400),(550,550),(300,850)]
width = 100
...
#pro.llsg_psf_subtraction(master_path,data_set,'ultra_centered',start_frame,end_frame,path_llsg_psf_subtraction,progress_print=True,frame_set='master',rank_input=10,thresh_input=1,max_iter_input=10)
#
