...
data_set = 'lm_161013_0'
data_set_flt_drk = 'lm_161013_00'
wd = 'WD0644+375'
master_path = '/Users/Ryan/research/data/WD0644+375/'
...
crop_parameter = 250
star_mag = 12.66
points = [(830,645),(500,500),(1000,1000)]
width = 100
...
##Nod positions were not included in raw data
#uti.nod_appender_A(master_path,data_set,'raw_data',start_frame,7774,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',7774,end_frame,progress_print=True)
#
##cropping
...
#pre.dewarper(master_path,data_set,'stripe_crcted',start_frame,end_frame,path_dewarped,crop_bottom=cb,crop_top=ct,crop_left=cl,crop_right=cr,date='2016B',side='sx',progress_print=True)
#
##Centering science frames
#pro.star_center(master_path,data_set,'dewarped',start_frame,7741,path_centered,progress_print=True,star_location=True,crop_parameter=crop_parameter)
##Centering science frames
#pro.star_center(master_path,data_set,'dewarped',7741,7744,path_centered,progress_print=True,star_location=True,crop_parameter=crop_parameter)
##Centering science frames
#pro.star_center(master_path,data_set,'dewarped',7744,end_frame,path_centered,progress_print=True,star_location=True,crop_parameter=crop_parameter)
#
##Bad frame detection
