...
master_path = '/Users/Ryan/research/data/WD0148+641_luci/'
...
#uti.nod_appender_A(master_path,data_set,'raw_data',start_frame,242,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',242,262,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',262,282,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',282,302,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',302,322,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',322,342,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',342,362,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',362,382,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',382,402,progress_print=True)
#uti.nod_appender_A(master_path,data_set,'raw_data',402,422,progress_print=True)
#uti.nod_appender_B(master_path,data_set,'raw_data',422,end_frame,progress_print=True)
#
##cropping
...
#pre.edge_crop(master_path,data_set,'raw_data',262,302,path_sci_edge_crop,crop_bottom=cb,crop_top=1610,crop_left=cl,crop_right=cr,progress_print=True,file_type='sci')
#pre.edge_crop(master_path,data_set,'raw_data',302,342,path_sci_edge_crop,crop_bottom=440,crop_top=ct,crop_left=cl,crop_right=cr,progress_print=True,file_type='sci')
#pre.edge_crop(master_path,data_set,'raw_data',342,382,path_sci_edge_crop,crop_bottom=cb,crop_top=1610,crop_left=cl,crop_right=cr,progress_print=True,file_type='sci')
#pre.edge_crop(master_path,data_set,'raw_data',382,402,path_sci_edge_crop,crop_bottom=440,crop_top=ct,crop_left=cl,crop_right=cr,progress_print=True,file_type='sci')
#pre.edge_crop(master_path,data_set,'raw_data',402,end_frame,path_sci_edge_crop,crop_bottom=cb,crop_top=1610,crop_left=cl,crop_right=cr,progress_print=True,file_type='sci')
